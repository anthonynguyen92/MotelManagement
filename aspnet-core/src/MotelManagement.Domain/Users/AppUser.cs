...
namespace MotelManagement.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update MotelManagementDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update MotelManagementEfCoreEntityExtensionMappings to extend the IdentityUser entity
